...
contract ERC20ForSplFactory {
    ...
    function createErc20ForSpl(
        bytes32 _mint
    ) public returns (address erc20spl) {
        require(
            getErc20ForSpl[_mint] == address(0),
            "ERC20 SPL Factory: ERC20_SPL_EXISTS"
        );
        ...
        require(
            erc20spl != address(0),
            "ERC20 SPL Factory: SPL TOKEN IS NOT CREATED"
        );
    ...
    function createErc20ForSplMintable(
        ...
        bytecode = abi.encodePacked(
            bytecode,
            abi.encode(_name, _symbol, _decimals, _mint_authority)
        );
        ...
        require(
            erc20spl != address(0),
            "ERC20 SPL Factory: SPL TOKEN MINTABLE IS NOT CREATED"
        );
